...
export const Projects = () => {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-12 mb-8 bg-slate-800">

        <div className="col-start-1 col-end-13 xl:col-end-9 h-full relative">
        ...
        <div className="col-start-1 xl:col-start-9 col-end-13 bg-slate-800 border-l-4 border-gray-950 ">
      ...
      <div className="grid grid-cols-12">
        ...
        <div className={`col-start-1 col-end-7 h-full relative z-10 border-b-4 border-r-4 border-gray-950 cursor-pointer delay-300
        ${isExpanded[1] === 0 ? "bg-slate-800" : "bg-slate-900 hover:bg-slate-800"}`}
          ...
          <div className={`p-4 w-full z-20 ${isExpanded[1] === 0 ? "opacity-100" : "opacity-75"}`}>
            ...
            <div className="mt-auto mb-0">
              ...
              <img src={isExpanded[1] === 0 ? "img/icon_left.svg" : "img/icon_right.svg"} className="h-8 float-right opacity-90" alt="Icon: Expand" />
            </div>
          </div>
        </div>

        <div className={`col-start-1 col-end-7 h-full relative z-10 border-b-4 border-r-4 border-gray-950 cursor-pointer
          ...
          <div className={`p-4 w-full z-20 ${isExpanded[1] === 1 ? "opacity-100" : "opacity-75"}`}>
            ...
            <div>
              ...
              <div className="mt-auto mb-0">
                ...
                <img src={isExpanded[1] === 1 ? "img/icon_left.svg" : "img/icon_right.svg"} className="h-8 float-right opacity-90" alt="Icon: Expand" />
              </div>
        ...
        <div className={`col-start-1 col-end-7 h-full relative z-10 border-r-4 border-gray-950 cursor-pointer
          ...
          <div className={`p-4 w-full z-20 ${isExpanded[1] === 2 ? "opacity-100" : "opacity-75"}`}>
            ...
            <div>
              ...
              <div className="mt-auto mb-0">
                ...
                <img src={isExpanded[1] === 2 ? "img/icon_left.svg" : "img/icon_right.svg"} className="h-8 float-right opacity-90" alt="Icon: Expand" />
              </div>
        ...
        <div className={`col-start-7 col-end-13 row-start-1 row-end-4 h-full bg-slate-800/95 origin-top-left p-8 pb-4
                ${isExpanded[1] !== 0 ? "-translate-x-full" : null} 
          ...
          <div className="flex flex-col justify-between h-full">
            ...
            <div className="mt-8 flex">
              ...
              <a href="https://github.com/lxnhard/movie_app-client" rel="noreferrer" target="_blank" title="View code on GitHub">
                <div className="inline-block py-2 px-8 mr-4 rounded-md bg-teal-800 hover:bg-opacity-80">
        ...
        <div className={`col-start-7 col-end-13 row-start-1 row-end-4 h-full bg-slate-800/95 origin-center-left p-8 pb-4
                ${isExpanded[1] !== 1 ? "-translate-x-full" : null} 
        ...
        <div className={`col-start-7 col-end-13 row-start-1 row-end-4 h-full bg-slate-800/95 origin-center-left p-8 pb-4
                ${isExpanded[1] !== 2 ? "-translate-x-full" : null} 
