    ...
    <>
      <div className="grid grid-cols-12">
        ...
        <div className="col-start-1 col-span-9">
          {projectIndex === 0 ?
            <ProjectCard
              title="Geschäftsbericht 2022 | Johannesstift Diakonie"
              imageUrl="img/johannesstift_diakonie-gb22.png"
              techstack={["React", "Javascript", "Bootstrap", "SCSS", "lottie-web"]}
              // githubUrl="https://github.com/lxnhard/movie_app-client"
              liveUrl="https://gb22.johannesstift-diakonie.de">
              <p className="mt-8 mb-4 dark:text-gray-400">
                Annual report landingpage for Johannesstift Diakonie. A Single Page Application written with React, utilizing various animations, complex transitions and self-hosted videos.</p>
              ...
              <h3 className="font-bold py-2">My role</h3>
              ...
              <h3 className="font-bold py-2 text-lg">Concept & Design</h3>
              <p className="mb-4 dark:text-gray-400">
              ...
              <ul className="list-disc list-outside pl-5">
                ...
                <li>
                  <span className="font-bold">dotlottie format: </span>
                  <span>
                ...
                <li>
                  <span className="font-bold">Cutting out micro-animations on mobile viewports: </span>
                  <span>
                    For the interactive network section, I decided to use static instead of micro-animated icons for mobile device viewports.
                  </span>
                </li>
              </ul>
              <h3 className="font-bold py-2">Bundle size</h3>
              ...
              <ul className="list-disc list-outside pl-5">
                ...
                <li>
                  <span className="font-bold">Selective ES6 imports of dependencies: </span>
                  <span>
              ...
              <h3 className="font-bold py-2">Iframe usage</h3>
              ...
              <h3 className="font-bold py-2">Retrospective</h3>
              <p className="mb-4 dark:text-gray-400">
              ...
              <p className="mb-4 dark:text-gray-400">
                ...
                <ul className="list-disc list-outside pl-5 mb-4">
                  <li>
                    <span>
                      Using a utility first CSS-framework like TailwindCSS instead of Bootstrap to decrease bundle size and maintain order.
                    </span>
                  </li>
                  <li>
                    <span>
